...
@InputType()
class MeasurementCreateNestedManyWithoutAssetsInput {
...
export { MeasurementCreateNestedManyWithoutAssetsInput as MeasurementCreateNestedManyWithoutAssetsInput };
